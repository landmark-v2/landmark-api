...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/info/comment/**").permitAll()
                .antMatchers(HttpMethod.GET, "/info/comment/**").permitAll()
                .antMatchers(HttpMethod.PUT, "/info/comment/**").permitAll()
                .antMatchers(HttpMethod.DELETE, "/info/comment/**").permitAll()
